<div class="span3" id="sidebar">
	<img id="avatar" src="admin/<?php echo $row['location']; ?>" class="img-polaroid">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				<li class=""><a href="teacher_students_grade.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-chevron-left"></i>&nbsp;Back</a></li>
				...
				<li class=""><a href="take_attendance.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>&nbsp;Take Attendance</a></li>
				...
				<li class=""><a href="#"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Student's Grade</a></li>
				<li class=""><a href="create_marks_poll.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Assign Marks</a></li>
			</ul>
</div>
